...
Because this guide uses email and password authentication, the example uses the code examples from the [email/password custom flow](./email-password.md) guide. If you are using a different authentication method, such as [email or SMS OTP](./email-sms-otp.md) or [email links](https://clerk.com/docs/pr/core-3/guides/development/custom-flows/authentication/email-links), you will need to adapt the code accordingly.
