...
Type used for all errors generated by the Clerk SDK. Additional error types such as [`ClerkAPIResponseError`](./clerk-api-response-error.md) and `ClerkRuntimeError` are instances of `ClerkError`.
